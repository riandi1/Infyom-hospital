<div id="editIpdPaymentModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.ipd_payments.edit_ipd_payment') }}</h5>
            ...
            <div class="modal-body">
                ...
                @endif
                <div class="alert alert-danger display-none" id="editPaymentValidationErrorsBox"></div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <div class="form-group">
                            ...
                            {{ Form::text('date', null, ['class' => 'form-control','id' => 'editIpdPaymentDate','autocomplete' => 'off', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        {{ Form::label('charge_type_id', __('messages.ipd_payments.payment_mode').':') }}<span
                                class="required">*</span>
                        {{ Form::select('payment_mode', $paymentModes, null, ['class' => 'form-control select2Selector', 'id' => 'editPaymentModeId', 'required','placeholder'=>'Select Payment Mode']) }}
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <div class="col">
                                ...
                                <label class="image__file-upload"> Choose
                                    {{ Form::file('file',['id'=>'editPaymentDocumentImage','class' => 'd-none document-file']) }}
                                </label>
                            </div>
                            <div class="col mt-2">
                                <img id='editPaymentPreviewImage'
