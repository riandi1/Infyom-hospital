<div class="row view-spacer">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <p>{{ !empty($patientCase->phone)?$patientCase->phone:__('messages.common.n/a') }}</p>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <p>{{ ($patientCase->status === 1) ? __('messages.common.active') : __('messages.common.de_active') }}</p>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <p>{!! !empty($patientCase->description)?nl2br(e($patientCase->description)):__('messages.common.n/a') !!}</p>
        </div>
    </div>
</div>
