    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('messages.incomes.edit_income')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::select('income_head', $incomeHeads, null, ['class' => 'form-control','required', 'id' => 'editIncomeHeadId']) }}
                    </div>
                    <div class="form-group col-sm-12">
                        {{ Form::label('name',__('messages.incomes.name').':') }}<span class="required">*</span>
                        {{ Form::text('name', null, ['class' => 'form-control','required', 'id' => 'editName']) }}
                    </div>
                    <div class="form-group col-sm-6">
                        {{ Form::label('date', __('messages.incomes.date').':') }}<label class="required">*</label>
                    ...
                    <div class="form-group col-sm-6">
                        {{ Form::label('amount', __('messages.incomes.amount').':') }}<span class="required">*</span>
