    ...
    <div class="card border-0">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!-- Company Name Field -->
                <div class="form-group col-sm-6">
                    {{ Form::label('company_name', __('messages.setting.company_name').':') }}<span
                            class="required">*</span>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    {{ Form::label('hospital_email', __('messages.setting.hospital_email').':') }}<span
                            class="required">*</span>
                ...
                <!-- Address Field -->
                <div class="form-group col-sm-6">
                    {{ Form::label('hospital_address', __('messages.setting.address').':') }}<span
                            class="required">*</span>
                    {{ Form::text('hospital_address', $settings['hospital_address'], ['class' => 'form-control', 'required']) }}
                </div>
                <!-- Currency Field -->
                <div class="form-group col-sm-6">
                    {{ Form::label('current_currency', __('messages.setting.currency').':') }}<span
                            class="required">*</span>
                    <select id="currencyType" data-show-content="true" class="form-control" name="current_currency">
                ...
                <div class="form-group col-sm-6">
                    <div class="row">
                        <div class="col-md-4 col-sm-3 col-6">
                            {{ Form::label('app_logo', __('messages.setting.app_logo').':') }}<span
                                    class="required">*</span>
                        ...
                        <div class="col-md-2 col-sm-6 col-6 preview-image-video-container pl-0 mt-1">
                            <img id='previewImage' class="img-thumbnail thumbnail-preview settingThumbnailPreview"
